...
public interface IClient
{
    ...
    Task CompleteMessage(QueueOrTopicName queue, MessageId id, CancellationToken ct = default);
    Task CompleteMessage(QueueOrTopicName topic, SubscriptionName subscription, MessageId id, CancellationToken ct = default);
